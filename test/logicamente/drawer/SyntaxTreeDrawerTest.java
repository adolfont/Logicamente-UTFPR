...
public class SyntaxTreeDrawerTest {
	...
	public void testGetScreenPutsCompositeFormulasInTheRightPlace() {
		...
		assertUsingDSL("A->B->C", new String[] { "oxooo", "xooxo", "ooxox" });
		assertUsingDSL("(A->B)->C", new String[] { "oooxo", "oxoox", "xoxoo" });
	}
	...
	// drawNode (x,y,string)
	// drawLineConnectingNodes (x1,y1, x2,x2) ==> COMO SABER QUE NÓS ESTÃO
	// CONECTADOS?
